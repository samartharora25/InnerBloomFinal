            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              <div className="text-center space-y-3">
                ...
                <p className="text-sm text-muted-foreground">
                  Call <a href="tel:14416" className="font-bold text-primary hover:underline cursor-pointer">14416</a> or <a href="tel:18008914416" className="font-bold text-primary hover:underline cursor-pointer">18008914416</a> for immediate connection to crisis counselors
                </p>
              </div>
